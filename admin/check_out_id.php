...
<?php
	...
	if(isset($_GET['memberID'])) {
		...
		redirect('check_out_ids.php?ID='.$ID.'&catalogID='.$catalogID.'&memberID='.$memberID.'&redirect='.$redirect, false);
	}
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
				  ...
				  <div class="modal-body">
					<form method="post" action="check_out_id.php?catalogID=<?php echo remove_junk($book_information['id'])?>&redirect=<?php echo $redirect;?>">
