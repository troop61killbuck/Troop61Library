...
$this->MultiCell(1,0.6,remove_junk(ucwords($a_book['titlecount'])),1,'C');
...
global $page_name;
    ...
    // Page number
    $this->Cell(0,0.393701,"Troop 61 Library - Catalog Titles",0,0,'L');
    $this->SetX(0);
...
$pdf->Write('.5',"Troop 61 Library - Catalog Titles");
