...
$all_members = find_all_current_members();
...
ob_clean();
$fp = fopen('/tmp/currentMembers.csv', 'w+');
fputcsv($fp, $headers);
...
fclose($fp);
  ...
  header("Content-disposition: attachment; filename = currentMembers.csv");
  readfile("/tmp/currentMembers.csv");
?>