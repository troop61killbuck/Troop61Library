    ...
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top navigation-clean-search" style="background: rgb(75,112,221);color: rgb(255,255,255);">
        <div class="container-fluid"><a href="index.php"><img class="img-fluid" src="logo/Troop61.png" width="50px"></a><a class="navbar-brand" href="index.php" style="margin: 0px 16px 0px 16px;"><?php echo $brand['Name'];?></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"><i clsass="fa fa-bars"></i></span></button>
            <div
                ...
                </ul><a class="btn btn-light ml-auto action-button" role="button" href="admin/index.php" target="_blank" <?php if($session->isMemberLoggedIn(true)):?>style="margin-right: 20px;"<?php endif;?>>Library Administration</a>
